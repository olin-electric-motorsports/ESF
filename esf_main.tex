...
According to the above calculations, the resistors will have to be rated to at least 5W and 300V. We will be using Vishay PAC500001002FAC000 10k 5W resistors. The datasheets for the resistors, the connectors, and an example multimeter can be found in \fref{sec:appendix_TSMP}.
