...
to the exterior and front side of this enclosure, facing the front of the car\ref{Dashboard Right}. It must be contained outside of the box so that the buzzer is
...
\begin{figure}[H]\label{Dashboard Right}
\centering
...
Referred from section \ref{accumulator_temperature}.
...
\subsubsection{Charger}\label{Charger}
...
Referred from section \ref{energy_meter_mounting}.
