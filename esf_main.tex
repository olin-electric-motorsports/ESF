...
The IMD will be located inside the accumulator, as shown in \fref{fig:accumulator_hero}. This is a convenient location for the IMD as high voltage sensing lines must already be present here for the TSMP’s.
