...
\subsubsection{Position in car}
\hlr{The inertia switch will be located on the side of the dashboard enclosure, in reach of the driver as to fit EV5.7.4. It is mounted upwards, so the top body panel will have to be temporarily removed to reset it,} as seen in \fref{fig:inertia_switch_mount}.
