...
See \fref{fig:TSALcircuit} for a schematic diagram of the TSAL circuit.
...
All connections made by wires will be 20 AWG rated for 600V, 125°C and 7A, while all PCB traces will be a minimum of 12 mil, but nominally 20 mil in width. The TS voltage will be fused to 1A on the power line. The GLV voltage will be fused to 2A and its traces will be 50 mil in width and 2 oz/ft^2 in thickness, able to handle 2.3A of current due to the 2A max current draw of the TSAL.
