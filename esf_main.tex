...
\begin{figure}[H]
    ...
    \caption{\hlr{Render of preliminary discharge circuit PCB. The discharge resistor is a TO-247 package mounted to a heatsink. }}
    \label{discharge_pcb}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{\hlr{Ratings for Ohmite F and R series heatsinks. The discharge resistor heatsink is RA-T2X-25E, shown in the first row.}}
\end{figure}
