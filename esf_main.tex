...
All connections made by wires will be 20 AWG rated for 600V, 125°C and 7A, while all PCB traces will be a minimum of 12 mil, but nominally 20 mil in width. The TS voltage will be fused to 50mA on the power line. The GLV voltage will be fused to .25A on the control line and 1.25A on the power line with traces of at least 60 mil, able to handle 1.5A of current due to the 1.2A max current draw of the TSAL.
...
\begin{figure}[H]
\centering
\includegraphics[scale=.4]{AIL.png}
