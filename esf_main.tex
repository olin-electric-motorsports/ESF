...
% I am not sure if this is actually how we are doing it, but I am assuming it is correct until I have time to check.
...
>>>>>>> Added more detailed outline for section 2.5. Added specific references in section 2.2.1 and 2.2.2.
...
% reference {fig:IMDLatch_Schematic} and find out details of BMS
...
=======
% reference ??? in shutdown section (maybe MSP)
